...
\begin{table}
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{llllrrr}
            ...
            \midrule
            GPT-2    & frei          & schlecht & \num{1,5} & \SI{24}{\giga\byte}   & \SI{6}{\giga\byte}    & \SI{750}{\mega\byte}  \\
            GPT-3    & nur Inferenz  & gut      & \num{175} & \SI{1,4}{\tera\byte}  & \SI{350}{\giga\byte}  & \SI{43,8}{\giga\byte} \\
            GPT-4    & nur Inferenz  & sehr gut & ?         & \multicolumn{1}{c}{?} & \multicolumn{1}{c}{?} & \multicolumn{1}{c}{?} \\
            GPT-J    & frei          & gut      & \num{6,7} & \SI{104}{\giga\byte}  & \SI{26}{\giga\byte}   & \SI{3,4}{\giga\byte}  \\
            GPT-NeoX & frei          & gut      & \num{20}  & \SI{160}{\giga\byte}  & \SI{40}{\giga\byte}   & \SI{10}{\giga\byte}   \\

            LLaMA    & limitiert     & gut      & \num{7}   & \SI{56}{\giga\byte}   & \SI{14}{\giga\byte}   & \SI{3,5}{\giga\byte}  \\
                     & limitiert     & gut      & \num{13}  & \SI{104}{\giga\byte}  & \SI{23}{\giga\byte}   & \SI{5,8}{\giga\byte}  \\
                     & limitiert     & sehr gut & \num{33}  & \SI{264}{\giga\byte}  & \SI{66}{\giga\byte}   & \SI{16,5}{\giga\byte} \\
                     & limitiert     & sehr gut & \num{65}  & \SI{520}{\giga\byte}  & \SI{130}{\giga\byte}  & \SI{32,5}{\giga\byte} \\

            Llama 2  & limitiert     & gut      & \num{7}   & \SI{56}{\giga\byte}   & \SI{14}{\giga\byte}   & \SI{3,5}{\giga\byte}  \\
                     & limitiert     & gut      & \num{13}  & \SI{104}{\giga\byte}  & \SI{23}{\giga\byte}   & \SI{5,8}{\giga\byte}  \\
                     & limitiert     & sehr gut      & \num{70}  & \SI{560}{\giga\byte}  & \SI{140}{\giga\byte}  & \SI{35}{\giga\byte}   \\
            \bottomrule
        \end{tabular}}
    \caption[Übersicht über die zur Auswahl stehenden Modelle]{Übersicht über die zur Auswahl stehenden Modelle. Größe ist in Milliarden Parameter angegeben.}\label{tab:approach:models}
\end{table}
...
\begin{table}
    ...
    \begin{tabular}{ll}
        ...
        \bottomrule
    \end{tabular}
    \caption{Parameter für das Training des Llama 2 7B-Modells}\label{tab:training:parameter}
\end{table}
