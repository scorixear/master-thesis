...
\pic{results/loss.png}{Fehlerwerte des Trainingsdatensatezs}{Vergleich evaluierter Modelle und ihrer Fehlerwerte des Trainingsdatensatzes.}{fig:results:loss}
...
\pic[0.7]{results/question_understanding_total_type.png}{Heatmap des Fragenverständnis nach Fragetypen}{Heatmap des Fragenverständnisses der evaluierten Modelle nach Fragetypen.}{fig:results:question_understanding_total_type}
\pic{results/question_understanding_total_source.png}{Heatmap des Fragenverständnis nach Fragequellen}{Heatmap des Fragenverständnisses der evaluierten Modelle unterteilt nach Fragequellen.}{fig:results:question_understanding_total_source}
