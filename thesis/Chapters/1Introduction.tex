...
Die ethischen Leitlinien der \ac{gmds} \citep{gmds_eth} geben \enquote{sowohl den tragenden Gesellschaften als Institution als auch dem einzelnen Mitglied eine Orientierung,
...
Aufgeteilt in 16 Artikeln werden hier verschiedene Kompetenzen und Verantwortlichkeiten definiert, unter die auch das hier beschriebene System fällt.
...
Kapitel 4 umfasst Lösungsstrategien des in~\cref{sec:problemstellung} formulierten Problems mit einer anschließenden Beschreibung der Umsetzung dieser Lösungen in Kapitel 5.
