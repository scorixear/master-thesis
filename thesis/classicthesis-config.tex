...
% ****************************************************************************************************
\newcommand{\myTitle}{Question Answering auf dem Lehrbuch \enquote{Health Information Systems} mit Hilfe von unüberwachtem Training eines Pretrained Transformers\xspace}
...
\newcommand{\myTime}{30.09.2023\xspace}
...
\PassOptionsToPackage{activate={true,nocompatibility},final,tracking=true,kerning=true,spacing=true,factor=1100,stretch=12,shrink=12,final}{microtype}%final-even in draft mode
...
\lstset{language=[LaTeX]Tex,%C++,
    ...
    %keywordstyle=\color{RoyalBlue},%\bfseries, screen version
    keywordstyle=\color{gray}, % print version
...
\hypersetup{%
    ...
    %colorlinks=true, linktocpage=true, pdfstartpage=3, pdfstartview=FitV,% screen version
...
\usepackage{ntheorem} % for definitions in chapter 2
\usepackage{MnSymbol}
\usepackage{float} % for H placement
\usepackage{longtable} % multi page tables
\usepackage{pdflscape} % landscape pages
\usepackage{adjustbox} % for centering figures
