...
- `04_predict_llama2_paula.py`: Script for generating answer of continual pretrained LLaMA2 models, but adjusted to use bitsandbytes to load in model as 4bit version. Uses less memory.
...
Required for scripts `04_predict_llama2_base.py`, `04_predict_llama2_paula.py` and `04_predict_llama2.py`.
