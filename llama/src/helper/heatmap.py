        ...
        for type_name in y_labels:
            ...
            for source_name in x_labels:
                ...
                for model_name in self.models.keys():
                    source_f1_values.extend(self.models[model_name].types[type_name].sources[source_name]["f1"])
    ...
    def get_avgvalue_heatmap_total_by_model(self, value_name: str):
        ...
        for type_name in y_labels:
            ...
            for source_name in x_labels:
                source_values = []
                for model_name in self.models.keys():
                    source_values.append(self.models[model_name].types[type_name].sources[source_name][value_name])
    ...
    def get_makrof1_heatmap_total_by_type(self):
        ...
        for model_name in y_labels:
            ...
            for type_name in x_labels:
                type_f1_values = []
                for source_name in self.models[model_name].types[type_name].sources.keys():
                    type_f1_values.extend(self.models[model_name].types[type_name].sources[source_name]["f1"])
    ...
    def get_avgvalue_heatmap_total_by_type(self, value_name: str):
        ...
        for model_name in y_labels:
            ...
            for type_name in x_labels:
                type_values = []
                for source_name in self.models[model_name].types[type_name].sources.keys():
                    type_values.append(self.models[model_name].types[type_name].sources[source_name][value_name])
    ...
    def get_heatmap_by_type(self, type_name: str, value_name: str):
        ...
        for model_name in y_labels:
            ...
            for source_name in x_labels:
                if value_name not in self.models[model_name].types[type_name].sources[source_name]:
                    x_values.append(0)
                elif source_name not in self.models[model_name].types[type_name].sources:
                    x_values.append(0)
