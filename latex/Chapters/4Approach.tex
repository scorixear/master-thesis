...
\end{table}
\todo{tabelle 4.1: llama 2 fehlt, bei inferenz würde ich auch noch eine spalte für 4 bit hinzufügen. Mrd. Parameter kann in die caption zum Platz sparen. und GB auch. bei gpt-4 würde ich statt --- ? schreiben}
Hier zur Auswahl stehende Modelle sind GPT-2, GPT-3, GPT-4, GPT-J, GPT-NeoX und LLaMA, gezeigt in \cref{tab:approach:models}.
...
\todo{gibt ja auch noch 8 bit und weniger quantisiert}
...
\todo{finde ich etwas verwirrend, oben ist BERT erste wahl für qa, dann wird es gleich unten ausgeschlossen}
