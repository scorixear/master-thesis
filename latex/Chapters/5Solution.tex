...
\todo{parametertabelle 5.2 train file Zeile weglassen wegen overfull hbox oder alternativ tabulary mit lL für Umbruch }
\begin{table}
    \centering
    \begin{tabular}{ll}
        \toprule
...
\todo{tabelle: hat nvidia den Namen Tesla nicht abgelegt für die neuen Produkte?}
\begin{table}
    \centering
    \begin{tabular}{llll}
        \toprule
...
\todo{ich dachte das 7b Modell braucht 14GB im 16 Bit Modus? Wieso passt das nicht auf eine 24 GB GPU?}
...
\todo{gibts da nicht verschiedene versionen? llama 2 chat, llama 2 instruct und so? vielleicht ist das llama 2 instruct auf sowas trainiert? oder verwechsle ich da was?}
