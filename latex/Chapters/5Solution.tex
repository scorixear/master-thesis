...
Der Parameter \texttt{max\_grad\_norm} beschreibt die maximale Norm des Gradienten, die durch die Gewichte des Modells nicht überschritten werden darf.
...
\begin{table}
    ...
    \begin{tabular}[llll]
        ...
        \bottomrule
    \end{tabular}
    \caption{ GPU Werte des \ac{gpu} Computing Clusters des Rechenzentrums der Universität Leipzig}\label{tab:gpu-cluster}
\end{table}
\begin{table}
    \centering
    \begin{tabular}[llll]
        ...
        \bottomrule
    \end{tabular}
    \caption{ CPU Werte des \ac{gpu} Computing Clusters des Rechenzentrums der Universität Leipzig}\label{tab:cpu-cluster}
\end{table}
