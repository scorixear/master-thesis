...
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{results/answers_total.png}}
...
\begin{figure}
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{results/makro_total.png}}
