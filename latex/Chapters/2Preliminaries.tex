...
% API, Overfitting
%************ Sprachmodelle
Um die in \cref{sec:zielsetzung} genannten Ziele zu erreichen und die Lösungsschritte in \cref{ch:approach} nachvollziehen zu können, werden in diesem Kapitel die Grundlagen für die in dieser Arbeit verwendeten Begriffe und Konzepte gelegt.
...
Sprachmodelle werden in einer Vielzahl von Anwendungen eingesetzt, wie z.B. in der Übersetzung,
Textgenerierung, Spracherkennung, Chatbots und Textklassifikation.
...
Diese Aktivierungsfunktion war in früheren Netzen die Sigmoidfunktion \pcref{eq:sigmoid}.
In modernen Netzen und auch in Transformer-Modellen wird hier die ReLU-Funktion \pcref{eq:relu} verwendet.
\begin{align}
...
Die Funktionen werden in \cref{img:sigmoid,img:relu} dargestellt.
