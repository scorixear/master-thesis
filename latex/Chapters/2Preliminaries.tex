...
Anschließend wird ein kurzer Einstieg in das Thema Neuronale Netzwerke gegeben, in der die Funktionsweise dieser genauer betrachtet wird \pcref{sec:neuronale-netzwerke}.
...
\paragraph{Residuale Verbindungen}\mbox{} \\
...
\paragraph{Byte Pair Encoding}\mbox{} \\
...
\paragraph{Eingabevektoren}\mbox{} \\
