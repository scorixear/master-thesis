...
\footnote{\raggedright{}GMDS (2023). Definition Medizinische Informatik.\  https://www.gmds.de/aktivitaeten/medizinische-informatik/ (besucht am 07. 03. 2023).}.\todo{url macro benutzen damit die URLs richtig gesetzt und klickbar werden}
...
\todo{neue Version 3 zitieren \url{https://link.springer.com/book/10.1007/978-3-031-12310-8} Da kannst du auch schon mal reinlesen, das wird ja dann die Quelle fürs Training.}
...
\todo{ich würde vor Fußnoten kein Leerzeichen stellen}
...
\todo{mir fehlt hier der Zwischenschritt "Informationssysteme". Zuerst schreibst du über Medizinische Informatik und dann über Management von Informationssystemen aber das wichtigste sind hier die Informationssysteme (im Gesundheitswesen) selbst. Im blauen Buch geht es ja nicht nur um das Management sondern auch die Beschreibung von Informationssystemen.}
...
\begin{itemize}
  \item Ziel Z1: Beantwortung von Fragen zu \citet{bb} in natürlicher Sprache durch eine Konversation-KI\todo{die Fragen sollen mithilfe der neuen (dritten) Auflage von 2023 beantwortet werden.}
