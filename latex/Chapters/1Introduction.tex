...
\begin{itemize}
  ...
  \todo{Futur 1 umformulieren, im Präsens bleiben (z.B. kann/soll/muss... oder Ziel ist... oder so ähnlich).}
\end{itemize}
...
\todo{cite Kommandos bitte nicht in Fußnoten packen}
...
\todo{Ich finde es nicht gut, Konversations-KI mit KI abzukürzen, weil du in der Arbeit sicher auch von KI im Allgemeinen schreiben wirst.}
...
Dazu gehört insbesondere die \enquote{Allgemeine Erklärung der Menschenrechte}\footnote{\url{https://www.un.org/depts/german/menschenrechte/aemr.pdf} (abgerufen
am 24.04.2023) },
\todo{ich kann es nur immer wieder schreiben: bitte ordentliche Bibtex-Einträge zitieren und nicht einfach Webseitenfußnoten erstellen :-)}
in der das \enquote{Verbot der Diskriminierung z.B. nach Geschlecht oder Rasse (Art. 2, 7)}
\todo{den Begriff Rasse finde ich im Deutschen problematisch, da es biologisch keine Menschenrassen gibt.
Es gibt aber anscheinend keine Version 2.0 davon also ist es wohl ein korrektes Zitat. Ich persönlich
würde wohl ein indirektes Zitat verwenden und \enquote{aus rassistischen Gründen} oder so schreiben aber wie du willst.}
verankert ist und
...
\todo{Du benutzt aber doch am Ende kein ChatGPT, bitte noch den Bogen dahin schlagen.}
...
Die KI unterstützt dabei den/die Fragende/n\todo{klingt für mich persönlich zu holprig, würde hier einfach Plural Fragende benutzen} durch eine Antwort in möglicherweise verständlicherer Form der wissenschaftlichen Erkenntnisse in \citet{bb}, 
...
\begin{itemize}
  ...
  \begin{itemize}
	...
	\todo{finde die Beispiele nicht optimal, Buchcover und Grafiken sind doch schon gar nicht mit drin wenn man z.B. das PDF als Text abspeichert.}
